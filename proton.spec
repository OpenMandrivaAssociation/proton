...
%package direct3d
Summary:       The Direct3D implementation from the Proton project
Group:         Emulators
Provides:      direct3d-implementation

%description direct3d
The Direct3D implementation from the Proton project
...
%package direct3d12
Summary:       The Direct3D 12 implementation from the Proton project
Group:         Emulators
Requires:      direct3d-implementation
Provides:      direct3d12-implementation

%description direct3d12
The Direct3D 12 implementation from the Proton project
...
sed -i 's,Icon=%{name},Icon=notepad,' %{buildroot}%{_datadir}/applications/mandriva-proton-notepad.desktop
sed -i 's,Icon=%{name},Icon=winefile,' %{buildroot}%{_datadir}/applications/mandriva-proton-winefile.desktop
sed -i 's,Icon=%{name},Icon=regedit,' %{buildroot}%{_datadir}/applications/mandriva-proton-regedit.desktop
sed -i 's,Icon=%{name},Icon=winemine,' %{buildroot}%{_datadir}/applications/mandriva-proton-winemine.desktop
sed -i 's,Icon=%{name},Icon=msiexec,' "%{buildroot}%{_datadir}/applications/mandriva-proton-wine uninstaller.desktop"
